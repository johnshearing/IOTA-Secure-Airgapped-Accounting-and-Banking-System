...
The editor is kind of like [CRISPR gene editing](https://en.wikipedia.org/wiki/CRISPR_gene_editing) which is used to change DNA and the generator is kind of like [Gene Therapy](https://en.wikipedia.org/wiki/Gene_therapy) because it propagates the changes throughout the entire system.  
