...
lib.nextId = function(idRange, callback)
{
  ...
  lib.gsuidLockReadIncUnlock(idRange, function(stopTrying, error, nextIdObject)
  {
    ...
    {
      let logObject = {};
      logObject.codeLocation = 'q2ba5ibvz4fa8cu6r6ch';
      logObject.message = 'Success! The next Id is the following:';
      logObject.nextId = nextIdObject;
      logObject.blankLine = '/n';
...
lib.append = function(dir, fileName, appendObject, callback)
{
  ...
  wStream.on('error', function(error)
  {
    ...
    (
      ...
      'Error creating a writable stream for ' + fileName + '\n' +
      'This was the error:' + '\n' +
      JSON.stringify(error) + '\n' +
      '\n'
    );
