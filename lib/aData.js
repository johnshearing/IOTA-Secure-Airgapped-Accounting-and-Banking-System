...
lib.append = function(dir, fileName, appendObject, callback)
{
  ...
  // Strip out unwanted extra consecutive backslashes leaving only one.
  // Required when data has escaped characters.
  // The JSON.stringify command above escapes escape characters.
  // This is why we have the extra backslashes to get rid of. 
  // Using a textarea element instead of an input element would also solve the
  // problem because then we would be seeing a literal newline character instead of the string \n.
