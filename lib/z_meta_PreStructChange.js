...
`
        ...
        persistArray.forEach(function(arrayElement)
        {
          if(arrayElement[2] === "topLevelDataField")
          {
            ...
            htmlString = htmlString +
            "      " + recordObject.tableName + "Object." + arrayElement[0] + " = " + arrayElement[1] + ";" + "\n";  
        ...
        function writeOutPostContainer()
        {
          ...
          containerArray.forEach(function(element)
          {
            ...
            if(!element[0].includes("0"))
            {
              ...
              htmlString = htmlString + 
`
      ${recordObject.tableName}Object.${element[0]} = {};`              
            }
...
`
      ...
      {`
                ...
                htmlString = htmlString + 
`
        ${recordObject.tableName}Object.${containerPath}["${containerName}" + arrayIndex.toString()] = {};
        ${recordObject.tableName}Object.${containerPath}["${containerName}" + arrayIndex.toString()].properties = {};` 
          ...
          bottomLevelDatafieldArray.forEach(function(element)
          {
            ...
            htmlString = htmlString + 
`
        ${recordObject.tableName}Object.${containerPath}["${containerName}" + arrayIndex.toString()].properties["${dataFieldName}"] = ${dataFieldName}Array[arrayIndex];`        
