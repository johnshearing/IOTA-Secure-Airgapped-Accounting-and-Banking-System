...
{ 
  ...
  let queryArray; // declared here because we need access to queryArray thoughout the entire function.
  ...
  if (typeof(Object.keys(data.queryStringObject)[0]) != 'undefined')
  {
    ...
    // client passes to the server in the query string.
    ...
    // Call the function defined above to decode special characters that 
    // the client may have passed to the server in the query string.
