...
handlers.userEdit = function(data, callback)
{
  ...
  if(data.method == 'get')
  {
    ...
    var templateData = 
    {
      ...
      //'head.clientCode' : 'public/app.js',
      //'head.clientCode' :  'accounting/database/dbPermission/user' + '/' + 'userEdit' + '.js'
      'head.clientCode' :  '' // Get rid of this as soon as all client code is embedded in the webpage.       
    };
...
handlers.userList = function(data, callback)
{
  ...
  if(data.method == 'get')
  {
    ...
    var templateData = 
    {
      ...
      'body.class' : 'userList',     
      // 'head.clientCode' :  'accounting/database/dbPermission/user' + '/' + 'userList' + '.js',
      'head.clientCode' :  '', // Probably get rid of this in the template.
      'tableName':'user',
      "tableLabel":"User"      
    };
...
handlers.userAdd = function(data, callback)
{
  ...
  if(data.method == 'get')
  {
    ...
    var templateData = 
    {
      ...
      'body.class' : 'userAdd',      
      'head.clientCode' :  '', // Get rid of this as soon as all client code is embedded in the webpage.     
      // 'head.clientCode' :  'accounting/database/dbPermission/user' + '/' + 'userAdd' + '.js', 
    };
