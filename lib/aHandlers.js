...
handlers._users.post = function(data, callback)
{
  ...
  {  
    ...
    readInterface.on('line', function(line) 
    {
      ...
      console.log('The value of lineObject.email is: ', lineObject.email);
      console.log('The value of lineObject.deleted is: ', lineObject.deleted);
      console.log(" ");           
    ...
    readInterface.on('close', function() 
    {
      if (emailIsUnique) // The email address is unique so proceed with append operation.
      {
        ...
        if(hashedPassword) // The hash function successfully returned the hashed password.
        {
          ...
          // 1 for userId in dbUsers, 2 for logId and 1 for Transaction id in dbLog to handle possible rollback.
          let idRange = 4;
                ...
                function(err)
                {
                      ...
                      function(err)
                      {
                        ...
                        else // There was an error appending to dbUsers.
                        {
                          ...
                          (
                            ...
                            'There was an error appending to the dbUsers file.' + '\n' +
                            'The following was the record we were trying to append:' + '\n' +
                            ...
                            function(err)
                            {
                              ...
                              { 
                                ...
                                (
                                  ...
                                  'No rollback entry was made in the dbUsers file' + '\n' +     
                  ...
                  else // There was an error appending to the dbLog file.
                  {
                    ...
                    (
                      ...
                      'But an error here surely means there was no append to dbUsers' + '\n' +                                          
