...
handlers.userCreate = function(data, callback)
{
  ...
  if(data.method == 'get')
  {
    ...
    // Read in a template as a string
    helpers.getTemplate('../accounting/dbPermissions/dbUsers/dbUsersCreate', templateData, function(err, str)
    {
      if(!err && str) // If there were no errors and a template was returned
      {
        // Add the universal header and footer.
...
// Define the handler function for creating user accounts in the demo system.
