...
app.loadoContactAddPage = function()
{
  ...
  function onClickBehaviorForAddNewObjectButton (event)  
  {
    ...
    // Append above the addNewObjectButton
      ...
      { 
        ...
        for (let property in formElementObj[objKey].properties)
        {
          ...
          if(formElementObj[objKey].properties[property].properties)
          {
            ...
            elementString = elementString + 
            "  ".repeat(objectNestLevel) + "      <button type=\"button\" class=\"controlObjectButton moveObjectUpButton blue\">Move Up</button>"  + "\n" + 
            "  ".repeat(objectNestLevel) + "      <button type=\"button\" class=\"controlObjectButton moveObjectDownButton blue\">Move Down</button>"  + "\n" + 
            "  ".repeat(objectNestLevel) + "      <button type=\"button\" class=\"controlObjectButton removeObjectButton red\">Remove</button>"  + "\n" +                         
