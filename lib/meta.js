...
`
        ...
        topFieldsArray.forEach(function (elementValue)
        {
          ...
          else // This top level field is not an object - It's just a regular field.
          {
            ...
            let defaultElementsObject = fieldsObject[elementValue].defaultElements;
...
`
        ...
        topFieldsArray.forEach(function (elementValue)
        {
          ...
          {  
            ...
            "      " + recordObject.table.tableName + "Object." + elementValue + " = " + elementValue + ";" + "\n";
          }
      ...
      writable.write = function(payload)     
      {
        ...
        for (let fieldKey in fieldsObject) 
        {
          ...
          {    
            ...
            // ??? Since filter and orderby clauses do not work with objects and because replicated objects
            // will break the search structure, it will be better pull out this code and not include
            // any objects in the select, filter, and orderby clauses.
            if(fieldsObject[fieldKey].properties)
            {
              ...
              function drillIntoObject(obj, objKey, startingPath)
              {
                ...
                {
                  propertyPath = startingPath + objKey + ".properties." + keyPart;
