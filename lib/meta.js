...
`
        ...
        for (let fieldKey in combinedDefaultElementsObject) 
        {
          ...
          if(fieldKey.includes("0"))
          {
            ...
            htmlString = htmlString +
`
  // Start of: Load the ${lastPart}Array with variables created dynamically once the payload is known.
...
`
  ...
  // End of: Load the ${lastPart}Array with variables created dynamically once the payload is known.  
