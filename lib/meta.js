...
`
        ...
        // console.log("5. These fields are unique keys: ", uniqueFieldsArray, "\n\n");
...
meta.makeAddPageElementHtml = function(elementName, recordObject)
{
  ...
  if(recordObject.webPages.addPage.forms.addForm.formElements[elementName].properties)
  {
    ...
    function drillIntoObject(formElementObj, objKey, previousObjKey, previousKeyPart, fieldsObject)
    {      
      // Here is where we do the drilling.
      for (let keyPart in formElementObj[objKey]) 
      {
        // if the subfield is also an object then this function calls itself using the subfield parameters.
        ...
        { 
          ...
          for (let property in formElementObj[objKey].properties)
          {
            ...
            if(formElementObj[objKey].properties[property].properties)
            {
              ...
              drillIntoObject(formElementObj[objKey].properties, property, objKey, keyPart, fieldsObject[objKey][keyPart]);
            ...
            { 
              ...
              let objectPath = objKey + "." + keyPart + "." + property;
              ...
              // Test to see if the current object is a container for more fields.
              // If the object is a container then we need a function here to drill into it.
              // if(recordObject.fields[objKey].properties[property].properties)
              if(fieldsObject[objKey].properties[property].properties)              
              {
                console.log("Drilling in. A function will go here.")
              }
              else // The current object is not a field container but rather a field.
              {
                // Start of merge the field with the formElement.
                ...
                console.log("This is the defaultElementObject\n", defaultElementsObject, "\n\n");
                console.log("formElementObj.properties[", property, "]\n", formElementObj[objKey].properties[property], "\n\n");
             
                // Deep merge the defaultElements with formElements - formElements taking precedence.
                let mergedElements = extend(true, defaultElementsObject, formElementObj[objKey].properties[property]);
                
                console.log("These are the mergedElements: ", mergedElements)
              } // End of: Test to see if the current object is a container for more fields.
      ...
      } // End of: // Here is where we do the drilling.
    ...
    drillIntoObject(recordObject.webPages.addPage.forms.addForm.formElements, elementName, "", "", recordObject.fields)
