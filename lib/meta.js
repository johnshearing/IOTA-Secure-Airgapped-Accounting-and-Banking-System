...
`          
    ...
    ${fieldCalculationCode}
        ...
        // The code below is the model for the code above. Delete code below after finishing the code above. ????
...
`
        ...
        for (let fieldKey in fieldsObject)
        {
              ...
              { 
                ...
                for (let property in Address[objKey].properties)
                {
                  ...
                  { 
                    ...
                    // If there is a populated defaultElements property for this field...
                    if(Address[objKey].properties[property].defaultElements && Object.keys(Address[objKey].properties[property].defaultElements).length > 0)  //????
                    {
          ...
          {  
            // If there is a populated defaultElements property for this field...
            if(fieldsObject[fieldKey].defaultElements && Object.keys(fieldsObject[fieldKey].defaultElements).length > 0)  //????
            {
              // then we will have data coming frome the form.
              // So make javascript that takes data from the form and loads 
              // it into the object we are going to write to the table              
