...
`
        ...
        // This loop organizes information from the persistArray to be fed into the function writeOutPostContainer()
        ...
        function writeOutPostContainer()
        {
...
`          
          ...
          lastWriteToBottomLevel = false;
        } // End of: function writeOutPostContainer(){...}
...
// This loop organizes information from the persistArray to be fed into the function writeOutPutContainer()
persistArray.forEach(function(arrayElement)
{
  if(arrayElement[2] === "topLevelDataField")
  {
...
`          
  ...
  bottomLevelDatafieldArray = [];
  lastWriteToBottomLevel = false;
} // End of: function writeOutPutContainer(){...}
// End of: Declare a function that writes javascript to persist nested documents.
                ...
                for (let property in address[objKey].properties)
                {
                  ...
                  { 
                    ...
                    if(address[objKey].properties[property].calculation && Object.keys(address[objKey].properties[property].calculation).length > 0)
                    {
                      ...
                      {
                        //???????
                        // Get fieldName from the objectPath
...
`        for (let arrayIndex = 0; arrayIndex < ${fieldName}Array.length; arrayIndex++) 
        {
          ...
          if(${fieldName}Array[arrayIndex]) // If the user supplied data for phone.properties.phone0.properties.phoneType
          {
          ...
          else // If the user did not supply data for ${xPath}
          {
            ...
            oContactObject.phone.properties["phone" + arrayIndex.toString()].properties["${fieldName}"] = ${fieldName}Array[arrayIndex];
          }
        } 
