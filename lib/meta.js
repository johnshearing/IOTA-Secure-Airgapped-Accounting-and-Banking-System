...
`
        ...
        for (let fieldKey in fieldsObject)
        {
          ...
          if(fieldsObject[fieldKey].properties)
          {
            ...
            // The one above is original code. ????
            // This one is without the spaces for making the persistArray.
            // propertiesPath = recordObject.table.tableName + "Object";
              ...
              { 
                ...
                if(objectNestLevelHistory === objectNestLevel)
                {
                  ...
                  */
                  ...
                  {
                    // persistArray.push(objKey + " = {}")
                    // persistArray.push(objKey + ".properties = {}")
                  ...
                  {
                    // persistArray.push(propertiesPath + "." + objKey + " = {}")
                    // persistArray.push(propertiesPath + "." + objKey + ".properties = {}")
                ...
                for (let property in address[objKey].properties)
                {
                  ...
                  { 
                    ...
                    // the above line is the original code. ????
          ...
          {  
            ...
            {
              // then we will have data coming frome the form.
              // So make javascript that takes data from the form and loads 
              // it into the object we are going to write to the table              
              // htmlString = htmlString +
...
`
        ...
        ${recordObject.table.tableName}Object.${containerPath}["${containerName}" + arrayIndex.toString()].properties = {};` 
          ...
          // Here is where we write out the embedded fields
              ...
              { 
                ...
                for (let property in address[objKey].properties)
                {
                  ...
                  { 
                    ...
                    {
                      htmlString = htmlString +
                      "  document.querySelectorAll(\"." + objectPath + "Input\").forEach(function (element){element.value = recordObject." + objectPath.split("_").join(".") + "});" + "\n";                      
                    }
        ...
        { 
          ...
          for (let property in formElementObj[objKey].properties)
          {
            ...
            if(formElementObj[objKey].properties[property].properties)
            {
              ...
              elementString = elementString + "  ".repeat(objectNestLevel) +
              "    <div class=\"objectLabel\">" + formElementObj[objKey].properties[property].labelText + "</div>" + "\n" + 
              "  ".repeat(objectNestLevel) + "    <div class=\"objectWrapper\">" + "\n";
            ...
            { 
              ...
              if(key === "editForm") // We are building HTML for the editForm on the editPage.
              {
                if(mergedElements.elementType === "input")
                {
                  ...
                  {
                    elementString = elementString + "  ".repeat(objectNestLevel) +       
                    "      <" + mergedElements.elementType + " class=\"" + objectPath + "Input\" name=\"" + objectPath + "\"" + attributeText + "\n" +
                    "  ".repeat(objectNestLevel) + "    </div>"  + "\n";
                  }
                  else // We did not specify attributes. Remove code that produces HTML for attributes.
                  {
                    ...
                    elementString = elementString + "  ".repeat(objectNestLevel) +       
                    "      <" + mergedElements.elementType + " class=\"" + objectPath + "Input\" name=\"" + objectPath + "\"" + ">" + "\n" +
                    "  ".repeat(objectNestLevel) + "    </div>"  + "\n";
