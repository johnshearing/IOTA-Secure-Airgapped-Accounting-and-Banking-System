            ...
            if(fieldsObject[fieldKey].dataType === "object")
            {
              ...
              function drillIntoObject(obj, objKey, startingPath)
              {
                ...
                for (let keyPart in objValue[objKey].properties) 
                {
                  ...
                  else // We are at the end of a branch.
                  {
                      let defaultElementsObject = objValue[objKey].properties[keyPart].defaultElements;
...
`
        ...
        {
          //???? Why is a two dimensional array necessary? Mistake? Take it out and see if everything still works.
          //???? Interesting - two dims works on a one dim array if the second dim is 0.
            ...
            {      
              ...
              { 
                ...
                for (let property in Address[objKey].properties)
                {
                  ...
                  {
                    // This function calls itself so as to go deeper into the object
                    drillIntoObject(Address[objKey].properties, property, objKey, objectNestLevel + 1);
                  }
                  else // This property is not an object. We are at the end of the branch where we encounter a formElement.
                  {
...
`
        ...
        keysOfFieldsArray.forEach(function (elementValue) // element value is the name of the field.
        {
        ...
        // console.log("6. These fields are calculated: ", calculatedFieldsArray, "\n\n");
        ...
        keysOfFieldsArray.forEach(function (elementValue)
        {
          ...
          if(calculatedFieldsArray.includes(elementValue))
          {
            htmlString = htmlString +  
            "      \"" + elementValue + "\" : \"\" ," + "\n";
          }
