...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
// For testing handlers._users.post() in the aHandlers file.
let handlers = require('./aHandlers');
let data = {};
data.payload = {};
data.payload.email = "alice@gmail.com";
data.payload.password = "ok";

let callback = function(statusCode, errorMessage)
{
  console.log(statusCode);console.log(statusCode, errorMessage);
}
...
let _data = require('./aData.js');
_data.read('dbPermissions/dbUsers/', 'dbUsers', function(err, data){
...
// let helpers = require('./aHelpers.js')
