  ...
  req.on('end', function()
  {
    ...
    chosenHandler(data, function(statusCode, payload, contentType)
    {
      ...
      if(contentType == 'json')
      {
        ...
        //console.log('The data type of the payload is: ', typeof(payload));
        //console.log('This is the payload that the server is sending: ', payload); 
        //console.log('This is the payload that the server is sending: ', payload._readableState.buffer.head.data.data);        
...
server.router = {
  '' : aHandlers.index,
  'user/create' : aHandlers.userCreate,
  'users/list' : aHandlers.usersList,  
  'users/edit' : aHandlers.usersEdit,    
