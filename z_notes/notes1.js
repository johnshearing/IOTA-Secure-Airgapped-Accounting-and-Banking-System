...
let _data = require('./aData.js');
_data.read('database/dbPermission/user/', 'user', function(err, data){
...
let _data = require('./aData.js');
_data.append('/database/dbPermission/user', 'user',{"id":72, "email":"charlie@gmail.com","hashedPassword":"36583a77a098c02ef111e2f2521d77b58e420f2bc7e9bf930ec24b21d42ea2e0"}, function(error){console.log(error)});
